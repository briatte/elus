...
print(xtable(filter(tbl, correlate == "Right-wing vote share")[, -2] %>%
             ...
             caption = "Pearson's correlation coefficients for associations between mean ideological positions and right-wing vote shares at the level of $N = 96$ \\emph{départements}.", label = "tbl:elections"),
      include.rownames = FALSE, booktabs = TRUE,
      file = "tables/elections.tex")
